...
previous_yaw = 0.0  
estimate_error = 1.0  
measurement_error = 0.1  # Measurement error (this can be tuned based on noise level)
kalman_gain = 0.0  
...
def main():
    ...
    global yaw_pub
    yaw_pub = rospy.Publisher('/filtered_yaw', Float64, queue_size=10)  # Publisher for the filtered YAW angle
